import { Plugin } from 'sapienafrica-ingress-controller-core/Plugin';
import { PluginRequest } from 'sapienafrica-ingress-controller-core/PluginRequest'
...
export class OpenIDConnectPlugin extends Plugin
{
    ...
    public async initialize(logger: Logger)
    {
        ...
        if (!DISCOVERY_URL || !CLIENT_ID || !CLIENT_SECRET) {
            console.error('One or more required environment variables are missing or null.');
